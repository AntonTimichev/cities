...
import {getOfferData} from "../../reducer/data/selectors";
import PropertyGallery from "../property-gallery/property-gallery.jsx";

const Property = ({offerData}) => {
  const {images, isPremium, title, rating, price, goods, host, description, maxAdults, bedrooms} = offerData;
